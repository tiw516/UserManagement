                ...
                <h3>That is me</h3>
                    <form method="POST" action="{{ route('update') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" onfocus="this.value=''" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="******" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" onfocus="this.value=''" class="form-control" name="password_confirmation" value="******" required>
                            </div>
                        </div>
